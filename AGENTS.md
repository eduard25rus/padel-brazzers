...
7. For individual Americano, validate the partner matrix before delivery: with 16 players and 15 rounds, each player must have 15 unique partners and no repeated partner. A duplicate partner means the score-card pairing was parsed incorrectly and must be fixed before import.
